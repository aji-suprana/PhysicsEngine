...
void TestSplitPick(const std::string& testName, const TriangleList& triangles, FILE* file = NULL)
{
...
void TestBspTreeStructure(const std::string& testName, TriangleList& triangles, FILE* file = NULL)
{
...
void TestRaycasts(TriangleList& triangles, Vector3& rayStart, float subDivisions, FILE* file)
{
  int debugDrawLevel = Application::mUnitTestValues.mDebugDrawLevel;
  BspTree bspTree;
  bspTree.Construct(triangles, splitWeight, epsilon);
...
void TriangleSplitTest1(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
...
void TriangleSplitTest2(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
  Triangle tri = Triangle(Vector3(-1, 0, 0), Vector3(1, 0, 0), Vector3(0, 1, 0));
  Plane plane;
...
void TriangleSplitTest3(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
  Triangle tri = Triangle(Vector3(-1, 0, 0), Vector3(1, 0, 0), Vector3(0, 1, 0));
  Plane plane;
...
void TriangleSplitTest4(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
  Triangle tri = Triangle(Vector3(-1, 0, 0), Vector3(1, 0, 0), Vector3(0, 1, 0));
  Plane plane;
...
void TriangleSplitTest5(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
  Triangle tri = Triangle(Vector3(-1, 0, 0), Vector3(1, 0, 0), Vector3(0, 1, 0));
  Plane plane;
...
void TriangleSplitTest6(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
  Triangle tri = Triangle(Vector3(-1, 0, 0), Vector3(1, 0, 0), Vector3(0, 1, 0));
  Plane plane;
...
void TriangleSplitTest7(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
  Triangle tri = Triangle(Vector3(-1, 0, 0), Vector3(1, 0, 0), Vector3(0, 1, 0));
  Plane plane;
...
void TriangleSplitTest8(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
  Triangle tri = Triangle(Vector3(-1, 0, 0), Vector3(1, 0, 0), Vector3(0, 1, 0));
  Plane plane;
...
void TriangleSplitTest9(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
  Triangle tri = Triangle(Vector3(-1, 0, 0), Vector3(1, 0, 0), Vector3(0, 1, 0));
  Plane plane;
...
void TriangleSplitTest10(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
  Triangle tri = Triangle(Vector3(-1, 0, 0), Vector3(1, 0, 0), Vector3(0, 1, 0));
  Plane plane;
...
void TriangleSplitTest11(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
  Triangle tri = Triangle(Vector3(-1, 0, 0), Vector3(1, 0, 0), Vector3(0, 1, 0));
  Plane plane;
...
void TriangleSplitTest12(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
  Triangle tri = Triangle(Vector3(-1, 0, 0), Vector3(1, 0, 0), Vector3(0, 1, 0));
  Plane plane;
...
void TriangleSplitTest13(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
  Triangle tri = Triangle(Vector3(-1, 0, 0), Vector3(1, 0, 0), Vector3(0, 1, 0));
  Plane plane;
...
void TriangleSplitTest14(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
  Triangle tri = Triangle(Vector3(-1, 0, 0), Vector3(1, 0, 0), Vector3(0, 1, 0));
  Plane plane;
...
void TriangleSplitTest15(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
  Triangle tri = Triangle(Vector3(-1, 0, 0), Vector3(1, 0, 0), Vector3(0, 1, 0));
  Plane plane;
...
void TriangleSplitTest16(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
  Triangle tri = Triangle(Vector3(-1, 0, 0), Vector3(1, 0, 0), Vector3(0, 1, 0));
  Plane plane;
...
void TriangleSplitTest17(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
  Triangle tri = Triangle(Vector3(-1, 0, 0), Vector3(1, 0, 0), Vector3(0, 1, 0));
  Plane plane;
...
void TriangleSplitTest18(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
  Triangle tri = Triangle(Vector3(-1, 0, 0), Vector3(1, 0, 0), Vector3(0, 1, 0));
  Plane plane;
...
void TriangleSplitTest19(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
  Triangle tri = Triangle(Vector3(-1, 0, 0), Vector3(1, 0, 0), Vector3(0, 1, 0));
  Plane plane;
...
void TriangleSplitTest20(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
  Triangle tri = Triangle(Vector3(-1, 0, 0), Vector3(1, 0, 0), Vector3(0, 1, 0));
  Plane plane;
...
void TriangleSplitTest21(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
  Triangle tri = Triangle(Vector3(-1, 0, 0), Vector3(1, 0, 0), Vector3(0, 1, 0));
  Plane plane;
...
void TriangleSplitTest22(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
  Triangle tri = Triangle(Vector3(-1, 0, 0), Vector3(1, 0, 0), Vector3(0, 1, 0));
  Plane plane;
...
void TriangleSplitTest23(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
  Triangle tri = Triangle(Vector3(-1, 0, 0), Vector3(1, 0, 0), Vector3(0, 1, 0));
  Plane plane;
...
void TriangleSplitTest24(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
  Triangle tri = Triangle(Vector3(-1, 0, 0), Vector3(1, 0, 0), Vector3(0, 1, 0));
  Plane plane;
...
void TriangleSplitTest25(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
  Triangle tri = Triangle(Vector3(-1, 0, 0), Vector3(1, 0, 0), Vector3(0, 1, 0));
  Plane plane;
...
void TriangleSplitTest26(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
  Triangle tri = Triangle(Vector3(-1, 0, 0), Vector3(1, 0, 0), Vector3(0, 1, 0));
  Plane plane;
...
void TriangleSplitTest27(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
  Triangle tri = Triangle(Vector3(-1, 0, 0), Vector3(1, 0, 0), Vector3(0, 1, 0));
  Plane plane;
...
void TriangleSplitTest28(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
  Triangle tri = Triangle(Vector3(-1, 0, 0), Vector3(1, 0, 0), Vector3(0, 1, 0));
  Plane plane;
...
void TriangleSplitTest29(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
...
void TriangleSplitTest30(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
...
void TriangleSplitTest31(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
...
void TriangleSplitTest32(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
...
void TriangleSplitTest33(const std::string& testName, FILE* file = NULL)
{
  float epsilon = 0.0001f;
...
void SplitPlanePickTest1(const std::string& testName, FILE* file = NULL)
{
...
void SplitPlanePickTest2(const std::string& testName, FILE* file = NULL)
{
  TriangleList triangles;
...
void SplitPlanePickTest3(const std::string& testName, FILE* file = NULL)
{
  TriangleList triangles;
...
void SplitPlanePickTest4(const std::string& testName, FILE* file = NULL)
{
  TriangleList triangles;
...
void SplitPlanePickTest5(const std::string& testName, FILE* file = NULL)
{
  TriangleList triangles;
...
void SplitPlanePickTest6(const std::string& testName, FILE* file = NULL)
{
  TriangleList triangles;
  triangles.push_back(Triangle(Vector3(1, 0, 0), Vector3(0, 1, 0), Vector3(0, 1, 1)));
  triangles.push_back(Triangle(Vector3(0, 1, 0), Vector3(1, 2, 0), Vector3(1, 2, 1)));
...
void TestBspTreeStructure1(const std::string& testName, FILE* file = NULL)
{
  TriangleList triangles;
  triangles.push_back(Triangle(Vector3(1, 0, 0), Vector3(0, 1, 0), Vector3(0, 1, 1)));
  triangles.push_back(Triangle(Vector3(0, 1, 0), Vector3(1, 2, 0), Vector3(1, 2, 1)));
...
void TestBspTreeStructure2(const std::string& testName, FILE* file = NULL)
{
  TriangleList triangles;
  CreateShape1(triangles);
  TestBspTreeStructure(testName, triangles, file);
...
void TestBspTreeStructure3(const std::string& testName, FILE* file = NULL)
{
  TriangleList triangles;
...
void TestBspTreeStructure4(const std::string& testName, FILE* file = NULL)
{
  TriangleList triangles;
...
void TestBspTreeStructure5(const std::string& testName, FILE* file = NULL)
{
  TriangleList triangles;
  Matrix4 transform = Matrix4::cIdentity;
...
void TestBspTreeStructure6(const std::string& testName, FILE* file = NULL)
{
  TriangleList triangles;
  Matrix4 transform = Matrix4::cIdentity;
...
void BspSimpleRayCast1(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
  ...
  TestRay(bspTree, ray, epsilon, file);
...
void BspSimpleRayCast2(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void BspSimpleRayCast3(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void BspSimpleRayCast4(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
// Test coplanar start
void BspSimpleRayCast5(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void BspSimpleRayCast6(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void BspSimpleRayCast7(const std::string& testName, FILE* file = NULL)
{
  int debugDrawLevel = Application::mUnitTestValues.mDebugDrawLevel;
  PrintTestHeader(file, testName);
...
void BspSimpleRayCast8(const std::string& testName, FILE* file = NULL)
{
  int debugDrawLevel = Application::mUnitTestValues.mDebugDrawLevel;
  PrintTestHeader(file, testName);
...
void BspRayCastStrestTest1(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
  ...
  TestRaycasts(triangles, Vector3(2, 3.5f, 0.5f), 20.0f, file);
}

void BspRayCastStrestTest2(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
  ...
  TestRaycasts(triangles, Vector3(1, 1, 0.5f), 10.0f, file);
  TestRaycasts(triangles, Vector3(3, 1, 0.5f), 10.0f, file);
}

void BspRayCastStrestTest3(const std::string& testName, FILE* file = NULL)
{
  TriangleList triangles;
...
void BspRayCastStrestTest4(const std::string& testName, FILE* file = NULL)
{
  TriangleList triangles;
  Matrix4 transform = Math::BuildTransform(Vector3::cZero, Quaternion::cIdentity, Vector3(3, 3, 3));
  LoadMesh("Sphere.txt", transform, triangles);
...
void BspRayCastStrestTest5(const std::string& testName, FILE* file = NULL)
{
  TriangleList triangles;
  Matrix4 transform = Math::BuildTransform(Vector3::cZero, Quaternion::cIdentity, Vector3(3, 3, 3));
  LoadMesh("Octohedron.txt", transform, triangles);
...
void BspCsgSimple1(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void BspCsgSimple2(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void BspCsgSimple3(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void BspCsgSimple4(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void BspCsgSimple5(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void BspCsgSimple6(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void BspCsgSimple7(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void BspCsgSimple8(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void BspCsgSimple9(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void BspCsgSimple10(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void BspUnion1(const std::string& testName, FILE* file = NULL)
{
  TriangleList tris1;
...
void BspIntersection1(const std::string& testName, FILE* file = NULL)
{
  TriangleList tris1;
  Matrix4 transform1 = Math::BuildTransform(Vector3::cZero, Math::ToQuaternion(Vector3(0, 0, 0), 0.0f), Vector3(1, 1, 1));
  LoadMesh("Octohedron.txt", transform1, tris1);
...
void BspSubtraction1(const std::string& testName, FILE* file = NULL)
{
  TriangleList tris1;
  Matrix4 transform1 = Math::BuildTransform(Vector3::cZero, Math::ToQuaternion(Vector3(0, 0, 0), 0.0f), Vector3(1, 1, 1));
  LoadMesh("Octohedron.txt", transform1, tris1);
...
void BspUnion2(const std::string& testName, FILE* file = NULL)
{
  TriangleList tris1;
  Matrix4 transform1 = Math::BuildTransform(Vector3::cZero, Math::ToQuaternion(Vector3(0, 0, 0), 0.0f), Vector3(1, 1, 1));
...
void BspIntersection2(const std::string& testName, FILE* file = NULL)
{
  TriangleList tris1;
  Matrix4 transform1 = Math::BuildTransform(Vector3::cZero, Math::ToQuaternion(Vector3(0, 0, 0), 0.0f), Vector3(1, 1, 1));
  LoadMesh("Cube.txt", transform1, tris1);
...
void BspSubtraction2(const std::string& testName, FILE* file = NULL)
{
  TriangleList tris1;
  Matrix4 transform1 = Math::BuildTransform(Vector3::cZero, Math::ToQuaternion(Vector3(0, 0, 0), 0.0f), Vector3(1, 1, 1));
  LoadMesh("Cube.txt", transform1, tris1);
...
void LargeCsg(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
